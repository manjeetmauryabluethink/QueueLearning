...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Bluethinkinc\QueueLearning\Model\Student::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('bluethinkinc_queuelearning_student');
            ...
            $this->dataPersistor->set('bluethinkinc_queuelearning_student', $data);
